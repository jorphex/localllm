...
MAIN_MODEL="${MAIN_MODEL:-Huihui-Qwen3-VL-8B-Thinking-abliterated-Q4_K_M.noctrex.gguf}"
MAIN_MMPROJ="${MAIN_MMPROJ:-mmproj-Huihui-Qwen3-VL-8B-Thinking-abliterated-F16.noctrex.gguf}"
MAIN_THREADS="${MAIN_THREADS:-10}"
MAIN_CONTEXT="${MAIN_CONTEXT:-47104}"
