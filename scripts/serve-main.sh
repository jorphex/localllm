...
MAIN_MODEL="${MAIN_MODEL:-Huihui-Qwen3.5-9B-abliterated.Q4_K_M.gguf}"
MAIN_MMPROJ="${MAIN_MMPROJ:-Huihui-Qwen3.5-9B-abliterated.mmproj-Q8_0.gguf}"
...
MAIN_EXTRA_ARGS="${MAIN_EXTRA_ARGS:--np 1 -tb 20 -b 4096 -ub 1024 -cram 1024 -fa on --threads-http 6 -ctk q8_0 -ctv q8_0}"
