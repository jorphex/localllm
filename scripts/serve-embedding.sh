...
EMBED_CONTEXT="${EMBED_CONTEXT:-16384}"
EMBED_UBATCH="${EMBED_UBATCH:-1024}"
EMBED_DEVICE="${EMBED_DEVICE:-none}"
EMBED_GPU_LAYERS="${EMBED_GPU_LAYERS:-0}"
EMBED_FIT="${EMBED_FIT:-false}"
EMBED_EXTRA_ARGS="${EMBED_EXTRA_ARGS:--np 8 -b 1024 -tb 12 -cram 0 --no-warmup -fa off --threads-http 2}"
